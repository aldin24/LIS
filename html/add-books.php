...
<div class="w3-container w3-half">
 ...
 <?php
	echo "Book Name:" . $_REQUEST['bookname'] ."</br>";
	echo "Author:".$_REQUEST['author']."</br>";
	echo "Release year:".$_REQUEST['releaseyear']."</br>";
	echo "Genre:".$_REQUEST['option']."</br>";
	echo "Publisher:".$_REQUEST['publisher']."</br>";
	echo "Stock:".$_REQUEST['stock']."</br>";
?>

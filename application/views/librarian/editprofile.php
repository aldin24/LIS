						...
						<span class="fileinput-new">Select image</span>
                                ...
                                <td width="90%" style="vertical-align:middle !important;">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" id="name" value="<?= $profile['full_name'] ?>" class="form-control" required autofocus maxlength="200" />
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td style="vertical-align:middle !important;">
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="email" id="email" value="<?= $profile['email'] ?>" class="form-control" required maxlength="200" />
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td style="vertical-align:middle !important;">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="mobile" id="mobile" value="<?= $profile['phone'] ?>" class="form-control" required max="999999999999999" />
                                    </div>
                                </td>
                            </tr>
                            <tr>

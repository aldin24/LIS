...
class Author_model extends CI_Model {
	...
	public function get() {
		$query = $this->db->query( "SELECT author.id, first_name, middle_name, last_name, COUNT(book_id) AS count FROM author LEFT OUTER JOIN written ON author.id = written.author_id GROUP BY CONCAT(first_name,middle_name,last_name)" );
